...
class Interfaz:
    ...
    def __init__(self, ventana ):
        ...
        #Inicializar la operacion mostrada en pantalla
        self.operacion =""
        ...
        boton4=self.crearBoton(u"\u232B",escribir=False) #Codigo unicode
    ...
    #Crea botones mostrando el valor
    ...
    #controla el evento disparo al hacer clik en un boton
    def click(self, texto, escribir):
        #Si el parametro escribir es True, entonces el parametro debe mostrarse en pantalla
        if not escribir:
            #Evalua si el usuario presiono '='
            if texto == "=" and self.operacion!="":
                #Remplaza el valor unicode de la division por el operador division
    ...
    #Muestra en la pantalla el contenido de las operaciones y resultados
